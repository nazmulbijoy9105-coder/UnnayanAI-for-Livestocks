...
const t = {
  en: {
    ...
    signup: "Sign Up",
    roles: { farmer: "Farmer", ngo: "NGO / Agent", mfi: "MFI Officer", investor: "Investor", admin: "Admin" },
  ...
  bn: {
    ...
    signup: "নিবন্ধন করুন",
    roles: { farmer: "কৃষক", ngo: "NGO এজেন্ট", mfi: "MFI কর্মকর্তা", investor: "বিনিয়োগকারী", admin: "অ্যাডমিন" },
...
const ROLE_ICONS: Record<string, string> = {
  farmer: "🌾", ngo: "🏢", mfi: "💳", investor: "💰", admin: "⚙️",
};
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-cyan-50">
      ...
      <div className="w-full max-w-md mx-4 relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">{txt.title}</h1>
            ...
            <div className="grid grid-cols-5 gap-2">
              {Object.entries(txt.roles).map(([key, label]) => (
                <button key={key} type="button" onClick={() => setRole(key)}
                  className={`flex flex-col items-center gap-1 py-2 px-1 rounded-xl border text-xs font-medium transition-all ${role === key ? "bg-emerald-500 border-emerald-500 text-white shadow-md" : "border-gray-200 text-gray-500 hover:border-emerald-300"}`}>
